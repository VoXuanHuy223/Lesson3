    ...
    <div class="main border col-md-6 row-justify-content-center  px-5 py-5 ">
        <table class="table-bordered ">
            ...
            <tbody>
                ...
                <td>
                    <a href="./editByUser.php?id=<?php echo $user['id']; ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                    <a href="#"><i class="fa-solid fa-ellipsis border border-primary border-3 rounded-circle"></i></a>
                    <a href="#"><i class="fa-regular fa-file"></i></a>
                    <a href="./profileUser.php?id=<?php echo $user['id']; ?>"><i class="fa-regular fa-eye"></i></a>
                </td>
            </tbody>
        </table>
